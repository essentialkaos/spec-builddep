...
all: spec-builddep ## Build all binaries

spec-builddep:
	@echo "[36;1mBuilding spec-builddep…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" spec-builddep.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp spec-builddep /usr/bin/spec-builddep

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/spec-builddep
